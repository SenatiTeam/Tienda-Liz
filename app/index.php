    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="conexBD_usuarioResgistro.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email"name="correoU" placeholder="Ingrese su correo electronico" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="rolesU" id="exampleInputRoles" class="form-select" aria-label="Default select example" >
                            <option selected>Selecionar los roles</option>
